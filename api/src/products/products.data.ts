...
export const categories: ProductCategory[] = ["사료", "간식", "장난감", "리빙"];
...
export const products: Product[] = [
  {
    ...
    description:
      "연어를 주원료로 사용한 그레인프리 건식 사료입니다. 상품 상세, 옵션, 리뷰 섹션을 확장하기 좋은 대표 상품입니다.",
    color: "bg-orange-200",
  ...
  },
  {
    ...
    description:
      "창가에 붙여 바깥을 구경하며 쉴 수 있게 돕는 해먹입니다. 설치 안내와 주의사항 콘텐츠를 상세 페이지에 더하기 좋습니다.",
    color: "bg-rose-200",
